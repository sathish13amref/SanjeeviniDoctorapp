      ...
      <div class="views">
		...
		<div class = "navbar">
                  ...
                  <div class="page-content">
                     <div class="content-block-title"><center><h1>FeedBack</h1></center></div>
                     <p><center>FeedBack from the patient. Only last ten messages will be displayed</center></p>
...
$id=$_GET['id'];
$query= $db->query("select * from patient_feedback where doctor_id='$id' LIMIT 10 ");
                           ...
                           <li class="accordion-item">
                              <a href="#" class="item-content item-link">
                                 <div class="item-inner">
                                    <div class="item-title"><?php echo $row['family_name'];?></div>
                                    <div class="item-after"><span class="badge color-orange"><?php echo $row['created_at'];?></span></div>
                                    <div class="item-after"><span class="badge color-red"><?php echo $row['stars'];?></span></div>
                                 </div>
                              </a>
